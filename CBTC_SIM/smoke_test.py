...
def main() -> int:
    import main_gui
    import reporting
    from scenario_loader import load_scenario, normalize_scenario

    default_scenario = load_scenario(PROJECT_DIR / "default_scenario.yaml")
    dense_path = PROJECT_DIR / "scenario_dense_4_trains.yaml"
    degraded_path = PROJECT_DIR / "scenario_moving_block_degraded.yaml"
    ...
    dense_source_curve_scenario = load_scenario(PROJECT_DIR / "default_scenario.yaml")
